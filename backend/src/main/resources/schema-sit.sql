-- H2 Database Schema for SIT Profile
...
DROP TABLE IF EXISTS TBL_SKU_STORE;
...
CREATE TABLE TBL_ORDER (
    ...
    TAX_ZERO VARCHAR(1),
    REINSTALL VARCHAR(1),
    PARENT_ORDER_ID VARCHAR(20),
    REINSTALL_REASON VARCHAR(200),
    EC_ORDER_ID VARCHAR(30),
    INVALID_REASON_ID VARCHAR(10),
    INVALID_DATE TIMESTAMP,
    INVALID_EMP_ID VARCHAR(20),
    INVALID_EMP_NAME VARCHAR(100)
);
...
CREATE TABLE TBL_ORDER_DETL (
    ...
    GOODS_AUTH_EMP_ID VARCHAR(20),
    GOODS_AUTH_EMP_NAME VARCHAR(100),
    GOODS_AUTH_REASON VARCHAR(200),
    INSTALL_AUTH_EMP_ID VARCHAR(20),
    INSTALL_AUTH_EMP_NAME VARCHAR(100),
    INSTALL_AUTH_REASON VARCHAR(200),
    CREATE_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UPDATE_DATE TIMESTAMP,
...
CREATE TABLE TBL_SKU_STORE (
    ...
    HOLD_ORDER VARCHAR(1),
    EVENT_NO VARCHAR(20),
    PROM_EVENT_NO VARCHAR(20),
    STAMP_EVENT_NO VARCHAR(20),
    DISPLAY_FLAG VARCHAR(1),
    MD_SELECTION VARCHAR(1),
    PROMOTION VARCHAR(1),
    FUTURE_PROMOTION VARCHAR(1),
    STORE_SELECTION VARCHAR(1),
    POG_FLAG VARCHAR(1),
    MODIFY_TIME TIMESTAMP,
...
-- Feature 002 indexes
CREATE INDEX IDX_ORDER_PROJECT ON TBL_ORDER(PROJECT_ID);
CREATE INDEX IDX_ORDER_MEMBER ON TBL_ORDER(MEMBER_CARD_ID);
CREATE INDEX IDX_ORDER_STORE ON TBL_ORDER(STORE_ID);
CREATE INDEX IDX_ORDER_STATUS ON TBL_ORDER(ORDER_STATUS_ID);
...
CREATE INDEX IDX_SKU_STORE_SKU ON TBL_SKU_STORE(SKU_NO);
CREATE INDEX IDX_SKU_STORE_STORE ON TBL_SKU_STORE(STORE_ID);
