...
- [ ] 001-keycloak-user-login 功能完成（登入與店別選擇）
- [ ] CRM 系統 API 規格確認
- [ ] 資料庫結構文件 (docs/tables) 完整性確認
...
- [ ] OrderPricingService: 12 步驟計價流程
- [ ] ProductEligibilityService: 6 層商品驗證
- [ ] MemberDiscountService: Type 0/1/2/Special 計算
- [ ] 折扣分攤計算（固定面額、百分比）

### 整合測試

- [ ] Order → Pricing Context 整合
- [ ] Order → Member Context 整合（CRM Mock）
- [ ] Order → Catalog Context 整合

### E2E 測試 (Playwright)

- [ ] 完整訂單建立流程（P1 User Story）
- [ ] 安裝服務選擇流程（P2 User Story）
- [ ] 會員折扣驗證（P3 User Story）
- [ ] 優惠券套用流程（P4 User Story）
- [ ] 關鍵步驟截圖驗證
...
| 業務規則正確性 | 待審核 | - | - |
| 技術可行性 | 待審核 | - | - |
| Constitution 合規性 | 待審核 | - | - |

---

**Generated by**: speckit.specify workflow
**Next Step**: 執行 `/speckit.clarify` 識別待釐清事項，或執行 `/speckit.plan` 進入實作規劃階段
